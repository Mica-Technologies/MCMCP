    ...
    private static void registerReadLog() {
        McpRegistry.registerTool(McpTool.named("game_read_log")
            ...
            .handler(context -> {
                ...
                // Text form rather than the pretty-printed JSON ToolResult.structured would produce:
                // a log excerpt is read as text, and JSON-escaping every line makes it materially
